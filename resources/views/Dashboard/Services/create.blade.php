    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        <div class="sidenav-header">
          ...
          <a class="navbar-brand m-0" href="#" target="_blank">
            ...
            <span class="ms-1 font-weight-bold">Control-Z</span>
          </a>
        </div>
            ...
            <div  class="card-body px-0 pt-0 pb-2 ">
                <form action="{{route('admin/storeservice')}}" method="POST">
                    ...
                    <div class="mb-3 container">
                        ...
                        <input name = "title" class="form-control" type="text" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                    <div class="mb-3 container">
                        <label for="exampleFormControlTextarea1" class="form-label">Description</label>
                        <textarea name = "description" class="form-control" type="text" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                    <div class="mb-3 container" >
